...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "armandocerna-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/cerna"
  #   chef.validation_client_name = "cerna-validator"
  #   chef.validation_key_path = ".chef/cerna-validator.pem"
  # end
end
